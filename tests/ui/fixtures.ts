...
export const coreCase: CoreRecord = {
  ...
  graphReady: true,
  formula: 'S(z)',
  output: { value: 1, components: [1, 0] },
  residual: 0,
  sourceUrl: 'https://example.test/core-source',
  sourceIdentity: {
    provenance: 'physics-monastery',
    sourceUrl: 'https://example.test/core-source',
  },
  sourceRevision: 'fixture-core-source-v1',
  implementationRevision: 'fixture-core-engine-v1',
  outputSchemaRevision: 'fixture-core-output-v1',
  compatibilityKey: 'c'.repeat(64),
  provenance: {
    claimClass: 'bounded-local-evaluation',
    evidenceRefs: [],
    sourceRevision: 'fixture-core-source-v1',
    sourceLocator: 'https://example.test/core-source',
    methodRelationship: 'browser evaluation of a declared Core preset',
    modelOrigin: 'declared Core preset',
    resultStatus: 'computed bounded local evaluation',
    caveats: ['Fixture graph readiness is not empirical validation.'],
    implementationRevision: 'fixture-core-engine-v1',
    contentRevision: 'fixture-core-output-v1',
  },
  finding: {
    schemaVersion: 1,
    changed: 'Declared Core preset planck-surface is selected for presentation.',
    cause: 'The route-owned Core worker evaluated the declared preset.',
    equation: 'S(z)',
    assumptions: ['Bounded float64 fixture evaluation.'],
    establishes: 'The fixture produced structured graph-ready output.',
    doesNotEstablish: 'This fixture is not empirical evidence and does not validate theory.',
    provenance: {
      claimClass: 'bounded-local-evaluation',
      evidenceRefs: [],
      sourceRevision: 'fixture-core-source-v1',
