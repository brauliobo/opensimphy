...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/labs/compute', name: 'compute', component: () => import('../views/ComputeView.vue'), meta: { title: 'Compute Lab' } },
    ...
    { path: '/labs/quantum-registers', name: 'quantum-registers', component: () => import('../views/QuantumRegistersLabView.vue'), meta: { title: 'Quantum Register Lab' } },
    { path: '/labs/clifford-space', name: 'clifford-space', component: () => import('../views/CliffordSpaceLabView.vue'), meta: { title: 'Clifford Space Lab' } },
    { path: '/labs/hyperbolic-partition', name: 'hyperbolic-partition', component: () => import('../views/HyperbolicPartitionLabView.vue'), meta: { title: 'Hyperbolic Partition Lab' } },
