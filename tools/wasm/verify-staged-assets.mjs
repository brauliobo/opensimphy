...
if (manifest.schema !== 4 || manifest.version !== lock.contentVersion || JSON.stringify(manifest.inputs) !== JSON.stringify(lock.inputs)) {
...
console.log(`verified ${partitionFiles.length} staged simulation assets in 3 partitions for ${manifest.version}`)
