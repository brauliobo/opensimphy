...
const requiredDistAssets = [
  ...
  'wasm/awesomePhysics/pymunk/NOTICE.md',
  'wasm/awesomePhysics/pymunk/pymunk.wasm',
  'wasm/awesomePhysics/ncollide/NOTICE.md',
  'wasm/awesomePhysics/ncollide/ncollide2d.wasm',
  'wasm/awesomePhysics/fluid-engine-dev/NOTICE.md',
  'wasm/awesomePhysics/fluid-engine-dev/fluid-engine-dev.wasm',
  'wasm/awesomePhysics/physx/NOTICE.md',
  'wasm/awesomePhysics/physx/physx-3-4.wasm',
  'wasm/awesomePhysics/newton-dynamics/NOTICE.md',
  'wasm/awesomePhysics/newton-dynamics/newton-dynamics.wasm',
  'wasm/awesomePhysics/spirit/NOTICE.md',
  'wasm/awesomePhysics/spirit/spirit-llg-heun.wasm',
  'wasm/awesomePhysics/galpy/NOTICE.md',
  'wasm/awesomePhysics/galpy/galpy.js',
  'wasm/awesomePhysics/galpy/galpy.wasm',
  'wasm/awesomePhysics/cantera/NOTICE.md',
  'wasm/awesomePhysics/cantera/cantera.js',
  'wasm/awesomePhysics/cantera/cantera.wasm',
]
...
const adapterSources = [
  ...
  'src/awesomePhysics/adapters/typescript/quantumPythonLectures.ts',
  'src/awesomePhysics/adapters/typescript/qutip.ts',
  'src/awesomePhysics/adapters/typescript/scikitBeam.ts',
  'src/awesomePhysics/adapters/typescript/raysect.ts',
  'src/awesomePhysics/adapters/typescript/quantumOpticsJl.ts',
  'src/awesomePhysics/adapters/typescript/astropy.ts',
